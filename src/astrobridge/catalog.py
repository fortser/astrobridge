...
OPERATIONS = {
    ...
    "mast.products": spec(["obsid"], {"obsid": TEXT("One obsid or comma-separated obsids (not obs_id)"), "page": prop("integer", "One-based result page", minimum=1, default=1)}, {"obsid": "27307305"}),
